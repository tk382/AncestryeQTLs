...
#do
#	name="$line"
#	Rscript cleanDataForTests.R $name
#done < "$filename"

Rscript cleanDataForTests.R Thyroid &
Rscript cleanDataForTests.R Uterus &
Rscript cleanDataForTests.R Vagina &
Rscript cleanDataForTests.R Whole_Blood
